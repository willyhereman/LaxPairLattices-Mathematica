...
(* worked for any A and B *)
(*
A = 1;
B = 1;
tchoice = 1/(A*(delta*p+(x-x1))); 
schoice = 1/(B*(delta*q+(x-x2))); 
*)
...
(* latter case the t and s must be given in this data file *)
...
(* Lax pair is given in this data file, if not, it will be compute with the *)
(* algorithm *)
